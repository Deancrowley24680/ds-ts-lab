import {
  ...
  function getBuddyListFriends(list: BuddyList): Friend[] {
    return list.members.reduce((friendList: Friend[], currentBuddy: Buddy) => {

        if ('phone' in currentBuddy) {
            friendList.push(currentBuddy as Friend);
        }
...
console.log("Buddy List Friends Are: ", getBuddyListFriends(myFootballBuddies));